...
import com.wcwy.oauth.service.JBWXLoginDetailServiceImpl;
import com.wcwy.oauth.service.RMWXLoginDetailServiceImpl;
 ...
 */
@Slf4j
public class AdWXLoginJobhunterTokenGranter extends AbstractTokenGranter {

    private static final String GRANT_TYPE = "tj_WXLogin";

    private JBWXLoginDetailServiceImpl userDetailsService;
    private PasswordEncoder bCryptPasswordEncoder;

    public AdWXLoginJobhunterTokenGranter(JBWXLoginDetailServiceImpl userDetailsService,
    ...
    protected AdWXLoginJobhunterTokenGranter(AuthorizationServerTokenServices tokenServices,
                                             ClientDetailsService clientDetailsService,
                                             OAuth2RequestFactory requestFactory,
                                             String grantType) {
