 ...
 */
@Slf4j
public class AdJobhunterPasswordTokenGranter extends AbstractTokenGranter {

    private static final String GRANT_TYPE = "tj_password";


    private AdJobhunterDetailServiceImpl userDetailsService;
    private PasswordEncoder bCryptPasswordEncoder;

    public AdJobhunterPasswordTokenGranter(AdJobhunterDetailServiceImpl userDetailsService,
    ...
    protected AdJobhunterPasswordTokenGranter(AuthorizationServerTokenServices tokenServices,
                                              ClientDetailsService clientDetailsService,
                                              OAuth2RequestFactory requestFactory,
                                              String grantType) {
