 ...
 */
@Slf4j
public class AdPasswordTokenGranter extends AbstractTokenGranter {

    private static final String GRANT_TYPE = "ad_password";


    private AdUserDetailServiceImpl userDetailsService;
    private PasswordEncoder bCryptPasswordEncoder;

    public AdPasswordTokenGranter(AdUserDetailServiceImpl userDetailsService,
    ...
    protected AdPasswordTokenGranter(AuthorizationServerTokenServices tokenServices,
                                     ClientDetailsService clientDetailsService,
                                     OAuth2RequestFactory requestFactory,
                                     String grantType) {
