 ...
 */
@Slf4j
public class AdWXLoginRecommendTokenGranter extends AbstractTokenGranter {

    private static final String GRANT_TYPE = "rm_WXLogin";

    private RMWXLoginDetailServiceImpl userDetailsService;
    private PasswordEncoder bCryptPasswordEncoder;

    public AdWXLoginRecommendTokenGranter(RMWXLoginDetailServiceImpl userDetailsService,
    ...
    protected AdWXLoginRecommendTokenGranter(AuthorizationServerTokenServices tokenServices,
                                             ClientDetailsService clientDetailsService,
                                             OAuth2RequestFactory requestFactory,
                                             String grantType) {
