 ...
 */
@Slf4j
public class AdRecommendPasswordTokenGranter extends AbstractTokenGranter {

    private static final String GRANT_TYPE = "rm_password";


    private AdRecommendDetailServiceImpl userDetailsService;
    private PasswordEncoder bCryptPasswordEncoder;

    public AdRecommendPasswordTokenGranter(AdRecommendDetailServiceImpl userDetailsService,
    ...
    protected AdRecommendPasswordTokenGranter(AuthorizationServerTokenServices tokenServices,
                                              ClientDetailsService clientDetailsService,
                                              OAuth2RequestFactory requestFactory,
                                              String grantType) {
