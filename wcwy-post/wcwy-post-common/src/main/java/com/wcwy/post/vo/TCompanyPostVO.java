...
public class TCompanyPostVO {
  ...
  /*  @ApiModelProperty(value = "自定义logo")
    ...
    @ApiModelProperty(value = "企业属性(0招聘企业 1猎头企业)",required = true)
  ...
  /*  @NotEmpty(message = "职位类别不能为空！")*/
    ...
    @NotBlank(message = "岗位描述描述！")
    //@Size(max = 1000,message = "职位描述不能超过1000个字符！")
