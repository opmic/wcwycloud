package com.wcwy.system.manager;





import com.wcwy.system.constant.Constants;
...
import com.wcwy.system.service.SysOperLogService;
import com.wcwy.system.service.SysRocketmqLogService;
import com.wcwy.system.service.impl.SysOperLogServiceImpl;
import com.wcwy.system.spring.SpringUtils;
import com.wcwy.system.utils.LogUtils;
import com.wcwy.system.utils.ServletUtils;
import com.wcwy.system.utils.StringUtils;
import com.wcwy.system.utils.ip.AddressUtils;
...
public class AsyncFactory
{
     ...
     * @return
     */
    public static TimerTask rocketMQ(final SysRocketmqLog operLog)
    {
        return new TimerTask()
        {
            @Override
            ...
            {
                // 远程查询操作地点
                SpringUtils.getBean(SysRocketmqLogService.class).insert(operLog);
            }
        };
    }
